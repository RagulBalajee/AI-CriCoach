...
def run_training():
    try:
        # Load both deliveries and match results
        df = load_data("data/deliveries.csv", "data/matches.csv")
        ...
        print("[SUCCESS] Model trained and saved to models/win_pred.pkl")
...
def run_live_demo():
    try:
        ...
        print(f"[ERROR] Live demo failed: {e}")
