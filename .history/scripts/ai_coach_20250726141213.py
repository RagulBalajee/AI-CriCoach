...
def main():
    ...
    while True:
        ...
        print("\n--- Scenario Simulation ---")
        print("Options:")
        print("  1) Lose a wicket")
        print("  2) Score a boundary")
        print("  3) Bowl a maiden")
        print("  4) Add 10 runs")
        print("  5) Lose 2 wickets")
        print("  6) Powerplay over (add 6 balls, 8 runs)")
        print("  7) Death over (add 6 balls, 12 runs)")
        print("  8) Rain interruption (skip 2 overs)")
        print("  9) Change player type")
        print(" 10) Change opposition strength")
        print(" 11) Custom scenario (set all values)")
        ...
        if option == "1":
            ...
            overs += 2
            balls_left -= 12
            print("Rain interruption! 2 overs lost.")
        elif option == "9":
