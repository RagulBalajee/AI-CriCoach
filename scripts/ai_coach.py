...
def main():
    ...
    print("==============================\n")
    # Impossible chase detection
    impossible_chase = False
    if match_type != "test" and target is not None and balls_left is not None:
        runs_needed = target - runs
        if runs_needed > balls_left * 6:
    ...
    while True:
        ...
        print("==============================")
        # Re-evaluate impossible_chase for the new scenario
        impossible_chase = False
        if match_type != "test" and target is not None and balls_left is not None:
            runs_needed = target - runs
            if runs_needed > balls_left * 6:
